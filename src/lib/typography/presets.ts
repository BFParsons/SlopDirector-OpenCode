...
export const TYPE_PRESETS: TypePreset[] = [
  ...
  { id: "title", name: "Title", use: "the title of the piece or a premise card — heavy grotesk, capitals, centred, big", font: "LiberationSans-Bold", transform: "upper", sizePct: 9, sizePctVertical: 6.5, position: "CENTER", color: "#FFFFFF", boxEnabled: false, boxColor: "#000000", boxOpacity: 0, outlineW: 0, shadow: 6, animation: "FADE", marginPx: 0, holdS: 3.5, maxChars: 18 },
