...
export const STYLES: Style[] = [
  ...
  // --- patriotic / political
  style("leni-riefenstahl", "Leni Riefenstahl", "political", "the monument: the mass as a shape, low angles for the figure, long smooth moves, cuts on the march", POL, [[4, 8], 1, "cuts", "none", "none", null, "required", "score", "mixed", "none", false, "none", true]),
